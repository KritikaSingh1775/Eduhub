...
import { Mail, MapPin, MessageCircle, Music, Send } from "lucide-react";
...
*New Contact Message from Rhythm Website*
*Name:* ${formData.name}
  ...
  const contactMethods = [
    {
      ...
      value: "Rhythmmusicals@gmail.com",
      link: "mailto:Rhythmmusicals@gmail.com",
    },
    {
      icon: MessageCircle,
      title: "WhatsApp",
      description: "Chat with us instantly",
      value: "+91 XXXXX 37618",
    ...
    },
    {
      ...
      value: "Rhythm Institutions for Music Lovers",
      ...
      <section className="relative min-h-[74vh] flex items-center justify-center overflow-hidden pt-20 sm:pt-24">
        ...
        <div className="relative z-10 max-w-4xl px-4 text-center">
          <span className="animate-fade-up inline-flex items-center gap-2 rounded-full border border-amber-600/35 bg-amber-600/10 px-4 py-2 text-sm font-semibold text-amber-300">
            <Music className="h-4 w-4" /> Contact Rhythm
          </span>
          ...
          <p className="animate-fade-up-delay-2 mx-auto mt-6 max-w-2xl text-base leading-relaxed text-slate-300/85 sm:text-lg">
            Questions, admissions, trial classes, or collaboration ideas. Reach
            out and our team will get back within 24 hours.
          </p>

          <div className="animate-fade-up-delay-2 mt-9 flex flex-wrap justify-center gap-3">
            <a
              href="mailto:Rhythmmusicals@gmail.com"
            ...
            >
              <Mail className="h-4 w-4" /> Rhythmmusicals@gmail.com
            </a>
            <a
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-5">
            <div className="space-y-6 lg:col-span-2">
              <div className="glass-card rounded-3xl p-6 sm:p-8">
                ...
                <p className="mt-3 text-slate-600">
                  From beginner classes to advanced training, we guide each
                  learner with a structured and friendly approach.
                </p>
              ...
              <div className="glass-card rounded-3xl p-6 sm:p-8">
                ...
                <p className="mt-2 text-slate-600">
                  Rhythm Institute for Music Lovers
                </p>
                <a
            ...
            <div className="glass-card rounded-3xl p-6 sm:p-8 lg:col-span-3">
              ...
              <p className="mt-3 text-slate-600">
                Submit this form and you will be redirected to WhatsApp with
              ...
              <form onSubmit={handleSubmit} className="mt-7 space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="instrument-rental">
                        Instrument Rental
                      </option>
                      <option value="product-purchase">Product Purchase</option>
                      <option value="event-booking">
                        Event / Performance Booking
                      </option>
                      <option value="collaboration">Collaboration</option>
                      <option value="custom-course">
                ...
                <p className="text-center text-xs leading-relaxed text-slate-500">
                  After submit, WhatsApp opens with your message so you can
                  review and send directly.
                </p>
              </form>
            </div>
          </div>
