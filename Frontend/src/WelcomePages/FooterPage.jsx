          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            >
              <div className="ft-brand">
                ...
                >
                  Professional music education rooted in the Guru-Shishya
                  tradition. Online & offline classes for all ages, all
                  instruments, all skill levels.
                </p>
                <div style={{ display: "flex", gap: ".75rem" }}>
                  <a
                    href="https://www.instagram.com/learnwith_Rhythm/"
                    target="_blank"
                  ...
                  <a
                    href="https://www.youtube.com/@Rhythmmusicacademy"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="ft-social"
                    aria-label="YouTube"
              ...
              <div>
                ...
                >
                  ...
                  <Link to="/About-Us" className="ft-link">
                    About Us
                  </Link>
                  <Link to="/Courses" className="ft-link">
                    Courses
                  </Link>
                  <Link to="/Notes" className="ft-link">
                    Notes
                  </Link>
                  <Link to="/Contact-Us" className="ft-link">
                    Contact Us
                  </Link>
              ...
              <div>
                ...
                <div className="ft-contact-row">
                  ...
                  <span>
                    xyz colony, sector XX , Faridabad
                  </span>
                </div>
                <div className="ft-contact-row">
