  ...
  const testimonials = [
    {
      name: "Priya Sharma",
      role: "Vocal Student",
      text: "Rhythm transformed my singing completely. The teaching is unmatched.",
    },
    {
      name: "Arjun Mehta",
      role: "Guitar Student",
  ...
  return (
    <div className="rp-shell min-h-screen overflow-x-hidden relative bg-[#fcfbf9]">
      ...
      <div className="relative z-10 w-full">
        ...
        <RevealSection>
          <SectionHeader tag="Meet The Founder" title="The Heart Behind Rhythm" />
        ...
        <RevealSection>
          <div className="rounded-[3rem] overflow-hidden shadow-2xl relative group pb-10">
            <img src={heroBg} alt="Join Rhythm" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
            ...
            <div className="relative z-10 p-10 sm:p-14 md:p-20 text-center">
              ...
              <p className="text-white/90 font-medium text-lg max-w-2xl mx-auto mt-6 leading-relaxed">
                Join hundreds of students learning music with heart at Rhythm Musical Classes.
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                ...
                <a href="mailto:Rhythmmusicals@gmail.com" className="border-2 border-white/40 bg-white/10 text-white backdrop-blur-md px-10 py-4 text-center font-bold rounded-xl inline-flex items-center justify-center gap-3 transition-all hover:bg-white/20 hover:scale-105 hover:translate-y-0">
...
export default RhythmWelcomeHome;
