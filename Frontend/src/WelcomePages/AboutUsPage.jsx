...
const StatCard = ({ stat, delay }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-slate-200/85 text-xs uppercase tracking-wider font-semibold">
        {stat.label}
      </p>
    </div>
  );
    ...
    >
      <div
        ...
        style={{
          border: hovered
            ? "4px solid #F59E0B"
            : "4px solid rgba(245,158,11,.3)",
          transition: "border-color .4s ease",
          boxShadow: hovered
            ? "0 8px 24px rgba(245,158,11,.4), 0 0 0 8px rgba(245,158,11,.1)"
            : "none",
        }}
      >
        <img
      ...
      <p className="text-amber-700 font-bold text-xs uppercase tracking-wider text-center mt-1 mb-4">
        {member.role}
      </p>
      <p className="text-slate-600 text-sm leading-relaxed mb-5">
        {member.bio}
      </p>
      <p className="text-xs uppercase tracking-[0.16em] text-slate-500 font-bold mb-2">
        Expertise
      </p>
      <div className="flex flex-wrap gap-2 mb-4">
        {member.expertise.map((skill) => (
          <span
            key={skill}
            className="px-3 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-700 border border-amber-300/60"
          >
            {skill}
          </span>
        ))}
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        {texts.map((t) => (
          <p key={t} className="text-slate-600 text-sm leading-relaxed">
            {t}
          </p>
        ))}
      </div>
...
const AboutUs = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      achievements: [
        "Teaching at Prayag Emerald Junior High School",
        "Teaching at Gayatri Tapobhoomi",
        "Teaching at St. Andrews School",
        "Prabhakar from Prayagraj Sangeet Samiti",
        "M.A in Music from  (2025)",
      ],
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "We believe genuine love for music is the foundation of great musical education and performance.",
    },
    {
      icon: Users,
      title: "Student-Centered",
      description:
        "Every student is unique. We tailor our teaching methods to individual learning styles and goals.",
    },
    {
      icon: GraduationCap,
      title: "Excellence",
      description:
        "We maintain the highest standards in teaching, curriculum, and student support services.",
    },
    {
      icon: BookOpen,
      title: "Comprehensive Learning",
      description:
        "From basic notes to advanced compositions, we cover music theory and practical skills.",
    },
    {
      icon: Mic,
      title: "Performance Focused",
      description:
        "Regular recitals and concerts to build confidence and stage presence in students.",
    },
    {
      icon: Star,
      title: "Innovative Methods",
      description:
        "Blending traditional teaching with modern technology and contemporary music trends.",
    },
  ];
  ...
  const facilities = [
    {
      ...
      description:
        "8 fully equipped soundproof rooms for individual and group practice sessions",
      image:
        "https://images.unsplash.com/photo-1651339764881-54e8338b185b?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "Recording Studio",
      description:
        "Professional recording setup for students to record their progress and compositions",
      image:
        "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    },
    {
      title: "Instrument Library",
      description:
        "Well-maintained collection of instruments available for student practice",
      image:
        "https://plus.unsplash.com/premium_photo-1682125896993-12a1758b6cb3?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "Performance Hall",
      description:
        "100-seat auditorium for regular student performances and recitals",
      image:
        "https://images.unsplash.com/photo-1597071692394-6661037e14ef?w=600&auto=format&fit=crop&q=60",
    },
  ];
  ...
  const instruments = [
    {
      name: "Piano",
      image:
        "https://images.unsplash.com/photo-1552422535-c45813c61732?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Guitar",
      image:
        "https://plus.unsplash.com/premium_photo-1693169973609-342539dea9dc?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Tabla",
      image:
        "https://images.unsplash.com/photo-1633411988188-6e63354a9019?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Flute",
      image:
    ...
    },
    {
      name: "Drums",
      image:
        "https://images.unsplash.com/photo-1543443258-92b04ad5ec6b?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Harmonium",
      image:
        "https://media.istockphoto.com/id/1367529261/photo/indian-classical-music.webp?a=1&b=1&s=612x612&w=0&k=20&c=CoYsfAPCP0e5nsv7-J5efD6nZu4bUFwhwZH42-TgJ1k=",
    },
    {
      name: "Vocals",
      image:
        "https://images.unsplash.com/photo-1615748562188-07be820cff5b?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Keyboard",
      image:
        "https://images.unsplash.com/photo-1614978498256-94ec73df1015?w=600&auto=format&fit=crop&q=60",
    },
    {
      name: "Dholak",
      image:
        "https://media.istockphoto.com/id/2195962108/photo/indian-traditional-drums-close-up.jpg?s=612x612&w=0&k=20&c=jqVw-ICQsZDN7z_EjPh6Aj0tlKmGhMEz6GJeI0NB2r8=",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[78vh] flex items-center justify-center overflow-hidden pt-20 sm:pt-24">
        ...
        >
          <source
            src={`${import.meta.env.BASE_URL}Video_of_Slow_Moving_Waves.mp4`}
            type="video/mp4"
          />
        </video>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-slate-100 mt-6 mb-4 au-fade-up-d1">
            About <span className="au-text-gradient">Rhythm</span>
          </h1>
          <p className="text-slate-300/85 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto au-fade-up-d2">
            Discover our journey, mission, and the passion that drives us to
            nurture musical talent across generations.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 au-fade-up-d2">
            <Link
              to="/Contact-Us"
              className="au-gold-gradient px-8 py-3 rounded-xl font-semibold shadow-lg shadow-amber-700/25 hover:-translate-y-0.5 transition"
            >
              Get Free Enquiry
            </Link>
        ...
        <div className="container mx-auto max-w-7xl px-4 flex flex-wrap justify-between items-center gap-4 text-sm">
          ...
          <div className="flex flex-wrap gap-5 text-slate-300">
            <span className="flex items-center gap-1.5">
              <Clock className="w-4 h-4 text-amber-400" /> Mon-Sat: 9 AM - 9 PM
            </span>
            <span className="flex items-center gap-1.5">
              <Calendar className="w-4 h-4 text-amber-400" /> Sunday: 9 AM - 6
              PM
            </span>
            <span className="flex items-center gap-1.5">
              <Phone className="w-4 h-4 text-amber-400" /> +91 84103 37618
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="relative px-4 py-16 bg-slate-50">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            tag="By The Numbers"
            title="Rhythm in Numbers"
            subtitle="A decade of musical excellence, student success, and community impact."
          />
      ...
      <section className="py-5 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 overflow-hidden border-y border-amber-500/25">
        <div className="flex au-marquee whitespace-nowrap">
          {[...heroInstruments, ...heroInstruments].map((name, i) => (
            <span
              key={i}
              className="mx-8 text-slate-200/85 text-xl sm:text-2xl font-semibold flex items-center gap-3"
            >
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            >
              <p className="text-xs uppercase tracking-[0.16em] text-amber-700 font-bold">
                Est. 2012
              </p>
            ...
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow =
                  "0 0 0 4px rgba(245,158,11,.3), 0 0 0 8px rgba(245,158,11,.15)";
              }}
            />
          </div>
          <div>
            ...
            <div className="space-y-4 -mt-4 text-slate-600 leading-relaxed">
              <p>
                Rhythm Musical Classes was founded in 2012 with a simple
                mission: to make quality music education accessible to everyone.
                What started as a small studio with just two instructors has now
                grown into a premier music institution with a thriving community
                of over 500 students.
              </p>
              <p>
                Our name "Rhythm" comes from the Sanskrit word for "pleasing to
                the heart," which reflects our philosophy that music should come
                from the heart and bring joy to both the performer and the
                listener.
              </p>
              <p>
                Over the years, we've expanded our curriculum to include 25+
                instruments, launched online classes, and established annual
                music festivals that showcase our students' talents.
              </p>
            </div>
            <div className="mt-6 flex items-start gap-3 p-4 rounded-xl border border-amber-500/20 bg-amber-50">
              ...
              <p className="text-sm text-slate-700 font-semibold">
                Award-winning music education institution - Best Music School
                2023
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="Comprehensive training in 25+ instruments across various musical traditions."
          />
          ...
          <div className="text-center mt-8">
            <p className="text-slate-600 text-sm mb-3">
              ...and many more! Contact us for instruments not listed here.
            </p>
            <Link
              to="/Contact-Us"
              className="inline-block au-gold-gradient px-6 py-3 rounded-xl font-semibold"
            >
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="State-of-the-art infrastructure designed for optimal learning experience."
          />
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="We believe that everyone has musical potential waiting to be discovered."
          />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="The principles that guide everything we do at Rhythm."
          />
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="The passionate musicians behind Rhythm."
          />
          <div className="grid md:grid-cols-2 gap-6">
            {teamMembers.map((m, i) => (
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading
            ...
            subtitle="Come experience the music in person."
          />
          <div className="grid lg:grid-cols-2 gap-8">
                ...
                {[
                  {
                    icon: MapPin,
                    label: "Main Campus",
                    content: "Rhythm Music Institute",
                  },
                  {
                    icon: Phone,
                    label: "Contact",
                    content: "+91 XXXXX 37618, +91 XXXXX 18590",
                  },
                  {
                    icon: Mail,
                    label: "Email",
                    content: "Rhythmmusicals@gmail.com",
                  },
                  {
                    icon: Clock,
                    label: "Hours",
                    content:
                      "Monday - Saturday: 9:00 AM - 9:00 PM, Sunday: 9:00 AM - 6:00 PM",
                  },
                ].map((item) => {
            ...
            <div className="au-card p-2 overflow-hidden h-[400px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3548.666687052142!2d77.95964401102849!3d27.198210876379967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39747702598cee49%3A0x8c378565a19b33c5!2sRhythm%20Music%20Academy!5e0!3m2!1sen!2sin!4v1763693224614!5m2!1sen!2sin"
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-10 sm:p-14 border border-amber-500/25">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">
              Ready to Start Your{" "}
              <span className="au-text-gradient">Musical Journey?</span>
            </h2>
            <p className="text-slate-300 max-w-2xl mx-auto mb-8">
              Join over 500 students who have discovered their musical potential
              with Rhythm. Limited spots available for{" "}
